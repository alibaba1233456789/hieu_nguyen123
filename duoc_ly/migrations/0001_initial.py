    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_0', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level0', verbose_name='<-- Level0')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noi_dung', models.TextField(blank=True, max_length=2000, null=True, verbose_name='nội dung')),
                ('level_1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level1', verbose_name='<-- Tiêu đề cấp 1')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noi_dung', models.TextField(blank=True, max_length=2000, null=True, verbose_name='nội dung')),
                ('level_2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level2', verbose_name='<-- Tiêu đề cấp 2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noi_dung', models.TextField(blank=True, max_length=2000, null=True, verbose_name='nội dung')),
                ('level_3', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level3', verbose_name='<-- Tiêu đề cấp 3')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noi_dung', models.TextField(blank=True, max_length=2000, null=True, verbose_name='nội dung')),
                ('level_4', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level4', verbose_name='<-- Tiêu đề cấp 4')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_5', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level5')),
            ],
        ),
        migrations.CreateModel(
            name='HinhAnhLv4',
            fields=[
                ...
                ('hinh', models.ImageField(upload_to='giaotrinh')),
                ('ten_hinh', models.CharField(max_length=200)),
                ('level_4', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level4')),
            ],
        ),
        migrations.CreateModel(
            name='HinhAnhLv3',
            fields=[
                ...
                ('hinh', models.ImageField(upload_to='giaotrinh')),
                ('ten_hinh', models.CharField(max_length=200)),
                ('level_3', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level3')),
            ],
        ),
        migrations.CreateModel(
            name='HinhAnhLv2',
            fields=[
                ...
                ('hinh', models.ImageField(upload_to='giaotrinh')),
                ('ten_hinh', models.CharField(max_length=200)),
                ('level_2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level2')),
            ],
        ),
        migrations.CreateModel(
            name='HinhAnhLv1',
            fields=[
                ...
                ('hinh', models.ImageField(upload_to='giaotrinh')),
                ('ten_hinh', models.CharField(max_length=200)),
                ('level_1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level1')),
            ],
        ),
        migrations.CreateModel(
            name='HinhAnhLv0',
            fields=[
                ...
                ('hinh', models.ImageField(upload_to='giaotrinh')),
                ('ten_hinh', models.CharField(max_length=200)),
                ('level_0', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='duoc_ly.level0')),
            ],
        ),
    ]
